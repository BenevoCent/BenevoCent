...
var GridList = (function(_Component) {
  ...
  function GridList() {
    ...
    return (0, _possibleConstructorReturn3.default)(
      this,
      (GridList.__proto__ || (0, _getPrototypeOf2.default)(GridList)).apply(
        this,
        arguments
      )
    )
  ...
  ;(0, _createClass3.default)(GridList, [
    {
      ...
      value: function render() {
        ...
        var wrappedChildren = _react2.default.Children.map(children, function(
          currentChild
        ) {
          if (
          ...
          var itemStyle = (0, _simpleAssign2.default)({}, styles.item, {
            ...
            height:
              cellHeight === 'auto' ? 120 : cellHeight * childRows + padding
          })
...
GridList.propTypes =
  process.env.NODE_ENV !== 'production'
    ? {
         ...
         */
        cellHeight: _propTypes2.default.oneOfType([
